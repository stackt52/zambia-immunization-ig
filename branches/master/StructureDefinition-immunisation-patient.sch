...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/zambia-training/StructureDefinition/patient-born-in-zambia']) &lt;= 1">extension with URL = 'http://openhie.org/fhir/zambia-training/StructureDefinition/patient-born-in-zambia': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:birthDate">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/patient-birthTime']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/patient-birthTime': minimum cardinality of 'extension' is 1</sch:assert>
